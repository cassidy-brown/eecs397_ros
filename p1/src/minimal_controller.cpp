...
int main(int argc, char **argv) {
    ros::init(argc, argv, "minimal_controller_p1"); //name this node 
    ...
    ros::Subscriber my_subscriber_object1 = nh.subscribe("velocity_p1", 1, myCallbackVelocity);
    ros::Subscriber my_subscriber_object2 = nh.subscribe("vel_cmd_p1", 1, myCallbackVelCmd);
    //publish a force command computed by this controller; 
    ros::Publisher my_publisher_object = nh.advertise<std_msgs::Float64>("force_cmd_p1", 1);
