...
int main(int argc, char **argv) {
    ros::init(argc, argv, "minimal_simulator_p1"); //name this node 
    ...
    ros::Subscriber my_subscriber_object = nh.subscribe("force_cmd_p1", 1, myCallback);
    //simulate accelerations and publish the resulting velocity; 
    ros::Publisher my_publisher_object = nh.advertise<std_msgs::Float64>("velocity_p1", 1);
    double mass = 1.0;
