...
// joint controller node for p4
// subscribes to pos_cmd and pos_cmd2
// publishes to a bunch of stuff
...
int main(int argc, char **argv) {
    ros::init(argc, argv, "joint_controller_p4");
    ros::NodeHandle nh;
