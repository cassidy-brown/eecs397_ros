...
int main(int argc, char **argv) {
    ros::init(argc, argv, "sin_commander_p4"); //name this node 
    ...
    ros::Publisher pos_publisher = nh.advertise<std_msgs::Float64>("pos_cmd", 1);
    ros::Publisher pos_publisher2 = nh.advertise<std_msgs::Float64>("pos_cmd2", 1);
    ...
    double radians2 = 0.0; // initialize at zero radians
    ...
    while (ros::ok()) {
        ...
        sin_pos_cmd.data = sin(radians * 0.8);  
